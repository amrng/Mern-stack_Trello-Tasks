  ...
  return (
    <div>
      <div className="row justify-content-evenly ">
        {allTasks?.tasks?.length === 0 ? <h1 className='text-center mb-4'>You have no tasks</h1>  : ""}
        {allTasks?.tasks?.length === 0 && allTasks.loading === true ? <div className='w-100 h-100 d-flex mt-5 pt-5'><i className="fa-solid mx-auto fa-spinner fa-spin-pulse fa-2xl load mt-5 "></i></div>  : ""}
