		...
		<div className="h-100 position-relative ">
			<form onSubmit={formik.handleSubmit}>
				<div className="row justify-content-center">
					...
					{allTasks?.tasks
						?.filter((task) => task._id === selectedTask.id)
						.map((task) => (
							<div
								key={task._id}
								className="col-md-10 bg-info bg-opacity-10 rounded-5 position-relative mb-4 p-3">
								...
								<button
									...
									className="btn btn-outline-danger mx-auto mt-3 py-1 d-block">
									Delete
								</button>
							</div>
						))}
				...
				<div className="w-50 mx-auto ">
					{formik.errors.title && formik.touched.title ? (
						<div className="alert alert-danger py-2 px-3 mb-1">
							<h6>
								Error:
								<span className="fw-light text-danger-emphasis">
									{' '}
									{formik.errors.title}
								</span>
							</h6>
				...
				<div className="row justify-content-center mb-5">
					<div className="form-group col-md-3 me-3 my-4">
						<input
							type="text"
							className="form-control bg-dark-subtle bg-opacity-10"
							name="title"
							id="title"
					...
					<div className="form-group col-md-10">
						<textarea
							...
							className="form-control bg-dark-subtle bg-opacity-25 col-md-10"
							name="description"
							id="description"
							rows={7}
					...
					<button
						type="submit"
						className="btn btndiv mx-auto w-25 mt-5  btn-outline-info">
						<i className="fa-regular fa-paper-plane me-2"></i>Update
					</button>
				</div>
			</form>
		</div>
